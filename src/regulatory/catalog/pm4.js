 ...
 *
 * Nota:
 * PM4.0 is calculated from the measured particle-size distribution and is treated here as complementary information.
 * ======================================================================
 */

const PM4_REGULATORY = Object.freeze({
    ...
    description:
        "Mass concentration of particulate matter with aerodynamic size up to approximately 4.0 µm.",
